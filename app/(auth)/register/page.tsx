  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-2 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-slate-100 placeholder:text-slate-500 outline-none ring-0 focus:border-indigo-400/50 focus:bg-white/10 transition"
      />
    </label>
  );
}
